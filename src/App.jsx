        ...
        <div className="dropdown">
          <div className="from">
            ...
            <div className="select-container">
              ...
              <Select options={currencyOptions} value={fromCurr} onChange={setFromCurr} styles={selectStyles} className="react-select-container" />
            </div>
          </div>
          ...
          <div className="to">
            ...
            <div className="select-container">
              ...
              <Select options={currencyOptions} value={toCurr} onChange={setToCurr} styles={selectStyles} className="react-select-container" />
            </div>
          </div>
        </div>
